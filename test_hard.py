...
def test_simple_uoc():
    ...
    assert is_unlocked(["COMP1511", "COMP1521", "COMP3411",
                        "COMP2521", "COMP2041", "COMP2511"], "COMP3901") == True
    assert is_unlocked(["COMP1511", "COMP1521", "COMP3411",
                        "COMP2521", "COMP2041", ], "COMP3901") == False

    assert is_unlocked(["COMP1511", "COMP1521", "COMP3411",
                        "COMP2521", "COMP2041", "COMP2511"], "COMP4601") == True
    assert is_unlocked(["COMP1511", "COMP1521", "COMP3411",
                        "COMP2521", "COMP2041", ], "COMP4601") == False

    assert is_unlocked(["COMP2521", "COMP2911", "COMP2511"], "COMP4601") == False
    assert is_unlocked(["COMP1511", "COMP2521", "COMP2911", "COMP2511"], "COMP4601") == True
